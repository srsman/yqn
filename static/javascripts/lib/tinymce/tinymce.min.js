    ...
    r(l, [], function () {
        ...
        function a(e) {
            ...
            function i() {
                ...
                var r = 0, i = [], o = [{
                    title: "标题",
                    items: [{title: "标题 1", format: "h1"}, {title: "标题 2", format: "h2"}, {
                        title: "标题 3",
                        format: "h3"
                    }, {title: "标题 4", format: "h4"}, {title: "标题 5", format: "h5"}, {
                        title: "标题 6",
                        format: "h6"
                    }]
                }, {
                    title: "内联",
                    items: [{title: "粗体", icon: "bold", format: "bold"}, {
                        title: "斜体",
                        icon: "italic",
                        format: "italic"
                    ...
                    title: "块",
                    items: [{title: "段落", format: "p"}, {
                        title: "块引用",
                        format: "blockquote"
                    }, {title: "分块/Div", format: "div"}, {title: "预格式化/Pre", format: "pre"}]
                }, {
                    title: "对齐",
                    items: [{title: "左对齐", icon: "alignleft", format: "alignleft"}, {
                        title: "居中对齐",
                        icon: "aligncenter",
                        format: "aligncenter"
            ...
            u = i(), s({
                ...
                blockquote: ["块引用", "mceBlockQuote"],
                numlist: ["编号格式", "InsertOrderedList"],
                bullist: ["项目符号", "InsertUnorderedList"],
                subscript: ["下标", "Subscript"],
                superscript: ["上标", "Superscript"],
                alignleft: ["左对齐", "JustifyLeft"],
                aligncenter: ["居中对齐", "JustifyCenter"],
                alignright: ["右对齐", "JustifyRight"],
                alignjustify: ["两端对齐", "JustifyFull"],
                ...
                var n = [], i = r(e.settings.block_formats || "Paragraph=p;标题 1=h1;标题 2=h2;标题 3=h3;标题 4=h4;标题 5=h5;标题 6=h6;Preformatted=pre");
